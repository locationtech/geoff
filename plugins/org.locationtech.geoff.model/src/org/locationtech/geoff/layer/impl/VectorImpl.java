 ...
 * <ul>
 *   <li>{@link org.locationtech.geoff.layer.impl.VectorImpl#getStyles <em>Styles</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VectorImpl extends LayerImpl implements Vector {
	...
	public EMap<String, Style> getStyles() {
		if (styles == null) {
			styles = new EcoreEMap<String, Style>(
					GeoffPackage.Literals.STYLE_ENTRY, StyleEntryImpl.class,
					this, LayerPackage.VECTOR__STYLES);
		}
		return styles;
	}
