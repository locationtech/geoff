 ...
 * <ul>
 *   <li>{@link org.locationtech.geoff.layer.impl.TileImpl#getSource <em>Source</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TileImpl extends LayerImpl implements Tile {
	...
	public NotificationChain basicSetSource(Source newSource,
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this,
					Notification.SET, LayerPackage.TILE__SOURCE, oldSource,
					newSource);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newSource != source) {
			...
			if (source != null)
				msgs = ((InternalEObject) source).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - LayerPackage.TILE__SOURCE,
						null, msgs);
			if (newSource != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					LayerPackage.TILE__SOURCE, newSource, newSource));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		switch (featureID) {
		case LayerPackage.TILE__SOURCE:
