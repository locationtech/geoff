 ...
 * @generated
 */
public class GeomSwitch<T> extends Switch<T> {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case GeomPackage.GEOMETRY: {
			Geometry geometry = (Geometry) theEObject;
			T result = caseGeometry(geometry);
			if (result == null)
				result = caseIdentifiable(geometry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GeomPackage.SIMPLE_GEOMETRY: {
			SimpleGeometry simpleGeometry = (SimpleGeometry) theEObject;
			T result = caseSimpleGeometry(simpleGeometry);
			if (result == null)
				result = caseGeometry(simpleGeometry);
			if (result == null)
				result = caseIdentifiable(simpleGeometry);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case GeomPackage.POINT: {
			...
			if (result == null)
				result = caseSimpleGeometry(point);
			if (result == null)
				result = caseGeometry(point);
			if (result == null)
				result = caseIdentifiable(point);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Simple Geometry</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Simple Geometry</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSimpleGeometry(SimpleGeometry object) {
		return null;
	}
