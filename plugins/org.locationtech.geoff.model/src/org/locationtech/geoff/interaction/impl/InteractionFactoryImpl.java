...
import org.locationtech.geoff.interaction.*;
...
public class InteractionFactoryImpl extends EFactoryImpl implements InteractionFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		...
		case InteractionPackage.EVENT_CONDITION:
			return createEventConditionFromString(eDataType, initialValue);
		default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
		case InteractionPackage.EVENT_CONDITION:
			return convertEventConditionToString(eDataType, instanceValue);
		default:
			throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier"); //$NON-NLS-1$ //$NON-NLS-2$
		}
	}
	 ...
	 * @generated
	 */
	public EventCondition createEventConditionFromString(EDataType eDataType, String initialValue) {
		EventCondition result = EventCondition.get(initialValue);
		if (result == null)
	 ...
	 * @generated
	 */
	public String convertEventConditionToString(EDataType eDataType, Object instanceValue) {
