...
/**
 * This is the item provider adapter for a {@link org.locationtech.geoff.source.VectorSource} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VectorSourceItemProvider extends SourceItemProvider {
	...
	public String getText(Object object) {
		String label = ((VectorSource) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_VectorSource_type") //$NON-NLS-1$
				:
				getString("_UI_VectorSource_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
