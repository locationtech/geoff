 ...
 * @generated
 */
public class VectorLayerItemProvider extends LayerItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VectorLayerItemProvider(AdapterFactory adapterFactory) {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(LayerPackage.Literals.VECTOR_LAYER__STYLES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(VectorLayer.class)) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(LayerPackage.Literals.VECTOR_LAYER__STYLES,
				GeoffFactory.eINSTANCE.create(GeoffPackage.Literals.STYLE_ENTRY)));
	}
