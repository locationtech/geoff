...
public class GeoffMapComposite extends Composite {
	private static final boolean ENABLE_BROWSER_POPUP_MENU = true;
	...
	public GeoffMapComposite(Composite parent, int style) {
		super(parent, style);
	...
	public void loadMap(String registryToken) {
		...
		renderer.prepareBrowser(browser);
		executeJS(String
				.format("window.geoff.loadFromServer('%s', true, 'map')",
						registryToken));
	}
